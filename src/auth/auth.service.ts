...
import { AlreadyExistsError, BadActivationLinkError, BadResetPasswordLinkError, NotExistsError, WrongPasswordError } from 'src/common/exceptions';
...
export class AuthService {
    ...
    async sendResetPassword(email) {
        ...
        await this.mailService.sendResetPasswordEmail(email, `${process.env.API_URL}/auth/reset-password/${findUser.login}/${link}`, password);
    }
